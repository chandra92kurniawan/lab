...
<head>
    ...
    <title>SMS GATEWAY SMA KP 2 BANDUNG</title>

    <!-- Bootstrap Core CSS -->
    <link href="<?php echo base_url()?>start/css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="<?php echo base_url()?>start/css/stylish-portfolio.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="<?php echo base_url()?>start/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
...
<body>
    ...
    <header id="top" class="header">
        <div class="text-vertical-center">
            ...
            <h3>SMA KARYA PEMBANGUNAN 2 BANDUNG</h3>
            <br>

            <!--<a href="#about" class="btn btn-dark btn-lg">Find</a>-->
        </div>
    </header>
    ...
    <section style="min-height:800px;" id="services" class="services bg-primary">
        <div class="container">
    ...
    <aside class="callout">
        <div class="text-vertical-center">
            <h1>Dengan Aplikasi Semua Menjadi Lebih Cepat</h1>
        </div>
    </aside>

    <!-- Portfolio #1abc9c -->
    <section style="min-height:800px;background:#1abc9c"  id="portfolio" class="portfolio">
        <div class="container">
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1 text-center">
					...
					<tr>
                        ...
                        <div class="col-md-6">
                            <div class="portfolio-item">
                                <a href="#">
                                    <script img class="img-portfolio img-responsive" src="<?php echo base_url()?>img/portfolio-2.jpg"> </script>
                                </a>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="portfolio-item">
                                <a href="#">
                                    <script img class="img-portfolio img-responsive" src=<?php echo base_url() ?>"img/portfolio-3.jpg"> </script>
                                </a>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="portfolio-item">
                                <a href="#">
                                    <script img class="img-portfolio img-responsive" src="<?php echo base_url()?>img/portfolio-4.jpg"> </script>
                                 </a>
                            </div>
                        </div>
                    </div>
                    <!-- /.row (nested) -->
                  <!--  <a href="#" class="btn btn-dark">Aplikasi Ini Membantumu</a> -->
                </div>
                <!-- /.col-lg-10 -->
            </div>
            <!-- /.row -->
    ...
    <!-- jQuery -->
    <script src="<?php echo base_url()?>start/js/jquery.js"></script>

    <!-- Bootstrap Core JavaScript -->
    <script src="<?php echo base_url()?>start/js/bootstrap.min.js"></script>
