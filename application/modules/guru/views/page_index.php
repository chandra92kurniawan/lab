<?php $this->load->view('top');?>
                        ...
                        <tr>
                          ...
                          <td>
                              <a href="#" class="btn btn-warning btn-xs" onclick="edit('<?php echo $data->nik;?>',
                                                                                        ...
                                                                                        '<?php echo $data->no_hp_guru;?>',
                                                                                        '<?php echo $data->jenis_kelamin;?>')"><i class="glyphicon glyphicon-edit"></i> Edit</a>
                              <a href="<?php echo base_url()?>guru/hapus/<?php echo $data->nik;?>" class="btn btn-danger btn-xs" onclick="if ( !confirm('Apakah anda akan menghapus karyawan <?php echo $data->nama_guru ?> ini ?')) return false;"><i class="glyphicon glyphicon-trash"></i> Hapus</a>
                          </td>
                        </tr>
                        <?php }?>
                      </tbody>
    ...
    <script type="text/javascript">
      $('#btn-add').click(function(){
        $('#frm-list').toggle();
        $('#frm-add').fadeIn('slow');
        $('.add-edit').attr('action',"<?php echo base_url()?>guru/add");
        $('#nik').val('');
        $('#nama_karyawan').val('');
        $('#alamat').val('');
        $('#no_hp').val('');
      ...
      function edit(id,nma,alm,tlp,jk)
      {
        ...
        $('#no_hp').val(tlp);
        $('#jk').val(jk);
        $('.add-edit').attr('action',"<?php echo base_url()?>guru/edit");
        $('#frm-list').toggle();
